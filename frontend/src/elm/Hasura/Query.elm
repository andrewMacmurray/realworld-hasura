...
-}
comments : (CommentsOptionalArguments -> CommentsOptionalArguments) -> SelectionSet decodesTo Hasura.Object.Comments -> SelectionSet (List decodesTo) RootQuery
...
-}
comments_by_pk : CommentsByPkRequiredArguments -> SelectionSet decodesTo Hasura.Object.Comments -> SelectionSet (Maybe decodesTo) RootQuery
...
-}
follows : (FollowsOptionalArguments -> FollowsOptionalArguments) -> SelectionSet decodesTo Hasura.Object.Follows -> SelectionSet (List decodesTo) RootQuery
...
-}
follows_by_pk : FollowsByPkRequiredArguments -> SelectionSet decodesTo Hasura.Object.Follows -> SelectionSet (Maybe decodesTo) RootQuery
...
-}
likes : (LikesOptionalArguments -> LikesOptionalArguments) -> SelectionSet decodesTo Hasura.Object.Likes -> SelectionSet (List decodesTo) RootQuery
...
-}
likes_aggregate : (LikesAggregateOptionalArguments -> LikesAggregateOptionalArguments) -> SelectionSet decodesTo Hasura.Object.Likes_aggregate -> SelectionSet decodesTo RootQuery
...
-}
user : UserRequiredArguments -> SelectionSet decodesTo Hasura.Object.Users -> SelectionSet (Maybe decodesTo) RootQuery
