...
module Hasura.Object.Likes_avg_fields exposing (..)
...
article_id : SelectionSet (Maybe Float) Hasura.Object.Likes_avg_fields
article_id =
    Object.selectionForField "(Maybe Float)" "article_id" [] (Decode.float |> Decode.nullable)


user_id : SelectionSet (Maybe Float) Hasura.Object.Likes_avg_fields
user_id =
